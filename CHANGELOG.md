...
- Platform: Custom attributes
  - Now selectable as a column
  - Support in report filters and charts
- Providers
  - Amazon: Public Images Filter
  - Networking
      - Separate Google Network Manager
      - NFV: VNFD Templates and VNF Stacks
  - Pluggability: SupportsFeatureMixin
...
- Performance
  ...
  - Imporved tag processing for Alert Profiles
...
- Providers:
  - Pluggability: Amazon Provider Repository
  - Hawkular
...
- REST API: Refactoring
  - Moving monolithic ApiController to OO model with collection specific classes and inheriting generic methods.
- User Interface
