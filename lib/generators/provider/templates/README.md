...
[![Join the chat at https://gitter.im/ManageIQ/manageiq-providers-<%= provider_name %>](https://badges.gitter.im/ManageIQ/manageiq-providers-<%= provider_name %>.svg)](https://gitter.im/ManageIQ/manageiq-providers-<%= provider_name %>?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
