module MiqAeMethodService
  module MiqAeServiceModelLegacy
    # Alias model names do not create depreciation warnings
    ALIAS_MODEL_NAMES = {
      'ems' => 'ExtManagementSystem'
    }

    # Legacy model names create depreciation warnings
    LEGACY_MODEL_NAMES = {
      # Amazon
    ...
    def service_model_lookup(model_name)
      ...
      if new_model_name
        "MiqAeMethodService::MiqAeService#{new_model_name}".constantize.tap do
          Vmdb::Deprecation.deprecation_warning(model_name, new_model_name)
        end
      else
