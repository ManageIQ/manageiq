module PrototypeHelper
  def deprecate_prototype_method(meth)
    unless Rails.env.production?
      msg = "[DEPRECATION] Prototype legacy method '#{meth}' is deprecated.  At #{caller[1]}"
      $log.warn msg if $log
      warn msg
    end
  end
  ...
  def button_to_remote(name, options = {}, html_options = {})
    deprecate_prototype_method :button_to_remote
  ...
  def submit_to_remote(name, value, options = {})
    deprecate_prototype_method :submit_to_remote
  ...
  def link_to_remote(name, options = {}, html_options = nil)
    deprecate_prototype_method :link_to_remote
  ...
  def form_remote_tag(options = {}, &block)
    deprecate_prototype_method :form_remote_tag
    options[:form] = true
  ...
  def remote_form_for(record_or_name_or_array, *args, &proc)
    deprecate_prototype_method :remote_form_for
  ...
  def evaluate_remote_response
    deprecate_prototype_method :evaluate_remote_response
  ...
  def observe_field(field_id, options = {})
    deprecate_prototype_method :observe_field
  ...
  def observe_form(form_id, options = {})
    deprecate_prototype_method :observe_form
