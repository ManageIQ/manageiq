...
CimProfiles.update do
  ...
  ontap_flex_vol_to_disk_extents do
    input_class 'ONTAP_FlexVolExtent'
    add   ontap_flex_vol_to_aggregate <<
      ontap_aggregate_to_plex << ontap_plex_to_raid_group << ontap_raid_group_to_disk_extents
  end

  ontap_file_share_to_disk_extents do
    input_class 'ONTAP_FileShare'
    add ontap_file_share_to_flex_vol << ontap_flex_vol_to_disk_extents
  end

  ontap_storage_volume_to_disk_extents do
