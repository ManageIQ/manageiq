...
# manageiq_plugin "manageiq-providers-microsoft"
gem "manageiq-providers-microsoft", :git => "https://github.com/juliancheal/manageiq-providers-microsoft", :branch => "master"
