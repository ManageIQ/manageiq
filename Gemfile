...
if RUBY_VERSION < "3.0"
# probably running ruby 2.7.6
# CVE-2021-33621 fixed: ruby 2.7.7 - https://github.com/advisories/GHSA-vc47-6rqg-c7f5
gem "cgi",  "~> 0.1.0.2"
# CVE-2023-36617 https://github.com/advisories/GHSA-hww2-5g85-429m
gem "uri",  "~> 0.10.0.3"
elsif RUBY_VERSION < "3.1"
# probably running ruby 3.0.4
