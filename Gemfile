...
gem "rack",                             "~>2.2", ">=2.2.13", :require => false # indirect dependency for CVE-2024-26146 (among others)
...
gem "stringio",                         "~>3.0.3",           :require => false # indirect dependency CVE-2024-27280 (resolved in ruby 3.0.7, ruby 3.1.5, and ruby >=3.2)
