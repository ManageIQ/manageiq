...
# manageiq_plugin "manageiq-providers-embedded_ansible"
gem "manageiq-providers-embedded_ansible", :git => "https://github.com/juliancheal/manageiq-providers-embedded_ansible", :branch => "master"
