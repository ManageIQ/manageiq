...
This image provides ManageIQ using the [podified frontend image](https://github.com/ManageIQ/manageiq-pods/tree/lasker/images/miq-app-frontend) as a base along with PostgreSQL.
