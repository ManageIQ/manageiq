...
class RcuService < Handsoap::Service
  ...
  def createClones(arg0)
    ...
    (parse_response(response, 'createClonesResponse')['return'])
  end
  ...
  def createDatastore(arg0, arg1)
    ...
    (parse_response(response, 'createDatastoreResponse')['return'])
  end
  ...
  def destroyDatastore(arg0, arg1)
    ...
    (parse_response(response, 'destroyDatastoreResponse')['return'])
  end
  ...
  def getMoref(arg0, arg1, arg2)
    ...
    (parse_response(response, 'getMorefResponse')['return'])
  end
  ...
  def getVmFiles(arg0, arg1)
    ...
    (parse_response(response, 'getVmFilesResponse')['return'])
  end
  ...
  def resizeDatastore(arg0, arg1)
    ...
    (parse_response(response, 'resizeDatastoreResponse')['return'])
  end
