class ManageIQ::Providers::Amazon::NetworkManager::EventCatcher::Runner < ManageIQ::Providers::BaseManager::EventCatcher::Runner
  ...
  def event_monitor_handle
    @event_monitor_handle ||= begin
      stream = ManageIQ::Providers::Amazon::NetworkManager::EventCatcher::Stream.new(@ems)
