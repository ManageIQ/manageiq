  ...
  class BaseController
    module Logger
      def log_request_initiated
        ...
        api_log_info(" ")
        api_log_info(format_data_for_logging("API Request",
      ...
      def log_api_auth
        ...
        api_log_info(format_data_for_logging("Authentication",
                                             :type        => auth_type,
        ...
        if User.current_user
          ...
          api_log_info(format_data_for_logging("Authorization",
                                               :user   => User.current_user.userid,
      ...
      def log_api_request
        ...
        api_log_info(format_data_for_logging("Parameters", @parameter_filter.filter(unfiltered_params)))
        log_request_body
      end
      ...
      def log_api_response
        ...
        return unless api_log_info?
        api_log_info(format_data_for_logging("Response",
