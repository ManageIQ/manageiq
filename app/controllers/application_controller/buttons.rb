module ApplicationController::Buttons
  ...
  def build_resolve_screen
    ...
    if matching_instances.any?
      ...
      @resolve[:new][:instance_name] = instance_name ? instance_name : @resolve[:new][:instance_name] ?
                                                                       @resolve[:new][:instance_name] : "Request"
      @resolve[:new][:object_message] = @custom_button && @custom_button.uri_message ||
                                        @resolve[:new][:object_message] ? @resolve[:new][:object_message] : "create"
