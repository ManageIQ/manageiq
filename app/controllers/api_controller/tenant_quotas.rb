class ApiController
  INVALID_QUOTA_ATTRS = %w(id href tenant_id unit)
  ...
  module TenantQuotas
    ...
    def quotas_create_resource(object, type, id, data)
    ...
    def quotas_edit_resource(object, type, id, data)
      bad_attrs = data_includes_invalid_attrs(data)
      if bad_attrs.present?
    ...
    def delete_resource_quotas(object, type, id, data)
