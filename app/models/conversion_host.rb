class ConversionHost < ApplicationRecord
  ...
  def self.notify_configuration_result(op, success, resource_info)
    Notification.create(
  ...
  def self.queue_configuration(op, instance_id, resource, params, auth_user = nil)
    task_opts = {
  ...
  def self.enable_queue(params, auth_user = nil)
  ...
  def disable(params)
    ...
    notify_configuration_result('disable', success, resource_info)
  end
