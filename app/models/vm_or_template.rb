...
class VmOrTemplate < ApplicationRecord
  ...
  REQUIRED_ADVANCED_SETTINGS = {
    ...
    'ppt_ratio'                  => [:ppt_ratio,                  :string],
    'enforce_affinity_check'     => [:enforce_affinity_check,     :boolean],
    'proc_units'                 => [:proc_units,                 :float],
    'dedicated_proc'             => [:dedicated_proc,             :boolean],
    'dedicated_sharing_mode'     => [:dedicated_sharing_mode,     :string],
    'uncapped'                   => [:uncapped,                   :boolean],
    'processor_compatibility'    => [:processor_compatibility,    :boolean],
    'shared_weight'              => [:shared_weight,              :integer],
    'availability_priority'      => [:availability_priority,      :integer],
    'boot_volume_type'           => [:boot_volume_type,           :string],
    'storage_connectivity_group' => [:storage_connectivity_group, :string],
    'ame_expansion_factor'       => [:ame_expansion_factor,       :string],
    'secure_boot'                => [:secure_boot,                :integer],
    'srr_capability'             => [:srr_capability,             :boolean],
    'shared_proc_pool_name'      => [:shared_proc_pool_name,      :string],
    'enable_lpar_metric'         => [:enable_lpar_metric,         :boolean],
  }
