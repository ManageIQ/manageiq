module ManageIQ::Providers::Redhat::InfraManager::Provision::StateMachine
  ...
  def powered_off_in_provider?
    destination.ext_management_system.inventory.powered_off_in_provider?(destination)
  end

  def powered_on_in_provider?
    destination.ext_management_system.inventory.powered_on_in_provider?(destination)
  end
end
