module ManageIQ::Providers::Redhat::InfraManager::Inventory
  ...
  class InventoryV4
    ...
    def collect_cluster_name_href(_ems, href)
    ...
    def collect_username_by_href(_ems, href)
      username = nil
      @ems.with_provider_connection(:version => 4) do |connection|
  ...
  class InventoryV3
    def collect_username_by_href(ems, href)
      username  = nil
    ...
    def collect_cluster_name_href(ems, href)
      ems.with_provider_connection do |rhevm|
