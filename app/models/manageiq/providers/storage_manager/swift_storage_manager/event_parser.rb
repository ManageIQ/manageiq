#
# TODO: (hsong) duplicate with ManageIQ::Providers::Openstack::NetworkManager::EventParser
#                   and ManageIQ::Providers::Openstack::InfraManager::EventParser
#
module ManageIQ::Providers::StorageManager::SwiftStorageManager::EventParser
