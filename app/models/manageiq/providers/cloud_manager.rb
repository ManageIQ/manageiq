module ManageIQ::Providers
  class CloudManager < BaseManager
    ...
    has_many :database_flavors,              :foreign_key => :ems_id, :dependent => :destroy, :class_name => 'DatabaseFlavor'
    has_many :flavors, -> { where.not(:type => DatabaseFlavor.descendants) }, :foreign_key => :ems_id, :dependent => :destroy
