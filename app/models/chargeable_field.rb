class ChargeableField < ApplicationRecord
  ...
  cache_with_timeout(:chargeable_cols_on_metric_rollup) { chargeable_cols_on_metric_rollup_without_cash }

  def self.chargeable_cols_on_metric_rollup_without_cash
