module ApplicationHelper
  ...
  def render_listnav_filename
    if @lastaction == "show_list" && !session[:menu_click] &&
      %w(auth_key_pair_cloud cloud_object_store_container cloud_object_store_object cloud_volume cloud_volume_backup
         cloud_volume_snapshot container_node container_service ems_container container_group ems_cloud ems_cluster
         container_route container_project container_replicator container_image container_image_registry container_build
  ...
  def show_adv_search?
    show_search = %w(availability_zone cim_base_storage_extent cloud_volume cloud_volume_backup cloud_volume_snapshot container_group container_node
                     container_service container_route container_project container_replicator container_image container_image_registry
