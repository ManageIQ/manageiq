module ApplicationHelper
  ...
  GTL_VIEW_LAYOUTS = %w(action availability_zone cim_base_storage_extent cloud_resource_quota cloud_tenant cloud_volume
                        cloud_volume_snapshot condition container_group container_route container_project
  ...
  def render_listnav_filename
    if @lastaction == "show_list" && !session[:menu_click] &&
       %w(auth_key_pair_cloud cloud_resource_quota cloud_volume cloud_volume_snapshot container_node container_service
          ems_container container_group ems_cloud ems_cluster container_route container_project
          container_replicator container_image container_image_registry
      ...
      "vm"
    elsif %w(action auth_key_pair_cloud availability_zone cim_base_storage_extent cloud_resource_quota
             cloud_tenant cloud_volume cloud_volume_snapshot condition container_group
