  ...
  button_group('miq_ae_method_vmdb', [
    select(:miq_ae_method_vmdb_choice, 'fa fa-cog fa-lg', N_('Configuration'), N_('Configuration'),
      :items     => [
        ...
        separator,
        button(:miq_ae_method_new, 'pficon pficon-add-circle-o fa-lg', N_('Add a New Method'), N_('Add a New Method')),
        button(:miq_ae_method_edit, 'pficon pficon-edit fa-lg', N_('Select a single Method to edit'), N_('Edit Selected Method'),
          :url_parms => "main_div",
          :enabled   => "false",
          :onwhen    => "1"),
        button(:miq_ae_method_copy, 'fa fa-files-o fa-lg', N_('Select Methods to copy'), N_('Copy selected Methods'),
          :url_parms => "main_div",
          :enabled   => "false",
          :onwhen    => "1+"),
        button(:miq_ae_method_delete, 'pficon pficon-delete fa-lg', N_('Remove selected Methods'), N_('Remove Methods'),
          :url_parms => "main_div",
