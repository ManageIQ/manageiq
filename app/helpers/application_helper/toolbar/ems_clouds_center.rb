      ...
      :items => [
        {
          ...
          :title        => N_("Refresh relationships and power states for all items related to the selected \#{ui_lookup(:tables=>\"ems_clouds\")}"),
          :url_parms    => "main_div",
        ...
        },
        {
          ...
          :text         => N_("Discover \#{ui_lookup(:tables=>\"ems_clouds\")}"),
          :title        => N_("Discover \#{ui_lookup(:tables=>\"ems_clouds\")}"),
          :url          => "/discover",
        ...
        },
        {
          ...
          :url          => "/new",
          :text         => N_("Add a New \#{ui_lookup(:table=>\"ems_cloud\")}"),
          :title        => N_("Add a New \#{ui_lookup(:table=>\"ems_cloud\")}"),
        },
        {
          :button       => "ems_cloud_edit",
          :icon         => "pficon pficon-edit fa-lg",
          :text         => N_("Edit Selected \#{ui_lookup(:table=>\"ems_cloud\")}"),
          :title        => N_("Select a single \#{ui_lookup(:table=>\"ems_cloud\")} to edit"),
          :url_parms    => "main_div",
          :enabled      => "false",
          :onwhen       => "1",
        },
        {
          ...
          :text         => N_("Remove \#{ui_lookup(:tables=>\"ems_clouds\")} from the VMDB"),
          :title        => N_("Remove selected \#{ui_lookup(:tables=>\"ems_clouds\")} from the VMDB"),
          :url_parms    => "main_div",
      ...
      :items => [
        {
          ...
          :title        => N_("Manage Policies for the selected \#{ui_lookup(:tables=>\"ems_clouds\")}"),
          :url_parms    => "main_div",
          :enabled      => "false",
          :onwhen       => "1+",
        },
        {
          ...
          :icon         => "pficon pficon-edit fa-lg",
          :text         => N_("Edit Tags"),
          :title        => N_("Edit Tags for the selected \#{ui_lookup(:tables=>\"ems_clouds\")}"),
          :url_parms    => "main_div",
          :enabled      => "false",
          :onwhen       => "1+",
        },
