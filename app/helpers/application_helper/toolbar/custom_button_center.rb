class ApplicationHelper::Toolbar::CustomButtonCenter < ApplicationHelper::Toolbar::Basic
  button_group('custom_button_vmdb', [
    select(:custom_button_vmdb_choice, 'fa fa-cog fa-lg', N_('Configuration'), N_('Configuration'),
      :items     => [
        button(:ab_button_edit, 'pficon pficon-edit fa-lg', N_('Edit this Button'), N_('Edit this Button'),
          :url_parms => "main_div"),
        button(:ab_button_delete, 'pficon pficon-delete fa-lg', N_('Remove this Button'), N_('Remove this Button'),
          :url_parms => "main_div",
        ...
        separator,
        button(:ab_button_simulate, 'fa fa-play-circle-o fa-lg', N_('Simulate using Button details'), N_('Simulate'),
          :url       => "resolve",
