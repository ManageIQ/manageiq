class ApplicationHelper::Toolbar::IsoDatastoreCenter < ApplicationHelper::Toolbar::Basic
  button_group('iso_datastore_vmdb', [
    select(:iso_datastore_vmdb_choice, 'fa fa-cog fa-lg', N_('Configuration'), N_('Configuration'),
      :items     => [
        button(:iso_datastore_delete, 'pficon pficon-delete fa-lg', N_('Remove this ISO Datastore from the VMDB'), N_('Remove this ISO Datastore from the VMDB'),
          :url_parms => "&refresh=y",
        ...
        separator,
        button(:iso_datastore_refresh, 'fa fa-refresh fa-lg', N_('Refresh Relationships for this ISO Datastore'), N_('Refresh Relationships'),
