class ApplicationHelper::Toolbar::MiqReportCenter < ApplicationHelper::Toolbar::Basic
  button_group('report_run', [
    button(:miq_report_run, 'fa fa-cog fa-lg', N_('Queue this Report to be generated'), N_('Queue')    ),
  ])
  button_group('report_vmdb', [
    select(:report_vmdb_choice, 'fa fa-cog fa-lg', N_('Configuration'), N_('Configuration'),
      :items     => [
        ...
        button(:miq_report_edit, 'pficon pficon-edit fa-lg', N_('Edit this Report'), N_('Edit this Report')),
        button(:miq_report_copy, 'fa fa-files-o fa-lg', N_('Copy this Report'), N_('Copy this Report')),
        ...
        button(:miq_report_delete, 'pficon pficon-delete fa-lg', N_('Delete this Report from the Database'), N_('Delete this Report from the Database'),
          :url_parms => "&refresh=y",
        ...
        button(:miq_report_schedule_add, 'fa fa-clock-o fa-lg', N_('Add a new Schedule'), N_('Add a new Schedule')),
      ]
    ),
  ])
end
