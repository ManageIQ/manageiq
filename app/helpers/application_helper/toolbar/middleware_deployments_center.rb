    ...
    select(
      ...
      :items   => [
        ...
        button(
          ...
          N_('Stop these Middleware Deployments'),
          N_('Stop'),
          :url_parms => "main_div",
          :enabled   => false,
          :onwhen    => "1+",
          :confirm   => N_("Do you want to stop these deployments ?")),
        button(
          :middleware_deployment_start,
          'fa fa-play-circle-o fa-lg',
          N_('Start these Middleware Deployments'),
          N_('Start'),
          :url_parms => "main_div",
          :enabled   => false,
          :onwhen    => "1+",
          :confirm   => N_("Do you want to start these deployments ?")),
        button(
