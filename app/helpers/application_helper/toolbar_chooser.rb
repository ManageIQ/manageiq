class ApplicationHelper::ToolbarChooser
  ...
  def center_toolbar_filename_classic
    ...
    if ((@lastaction == "show" && @view) ||
      ...
      unless @in_a_form
        if %w(auth_key_pair_cloud availability_zone cloud_tenant cloud_resource_quota cloud_volume cloud_volume_snapshot
              container_group container_node container_service ems_cloud ems_cluster
