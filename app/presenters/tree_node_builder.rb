class TreeNodeBuilder
  ...
  def build_object_id
    if object.id.nil?
      ...
      base_class = "ManageIQ::Providers::Foreman::ConfigurationManager" if base_class == "ExtManagementSystem" && object.kind_of?(ManageIQ::Providers::Foreman::ConfigurationManager)
      base_class = "ManageIQ::Providers::AnsibleTower::ConfigurationManager" if base_class == "ExtManagementSystem" && object.kind_of?(ManageIQ::Providers::AnsibleTower::ConfigurationManager)
