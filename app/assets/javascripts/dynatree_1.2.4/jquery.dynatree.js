...
//		this.tree.logDebug("dtnode.focus(): %o", this);
	...
	_activate: function(flag, fireEvents) {
		...
		if( flag ) {
			...
			if( opts.persist ){
				localStorage.setItem(opts.cookieId+"-active", this.data.key, opts.cookie);
			}
			...
			if( this.tree.activeNode === this ) {
				...
				if( opts.persist ) {
					...
					localStorage.setItem(opts.cookieId+"-active", "", opts.cookie);
				}
...
//		this.tree.logDebug("dtnode._onFocus(%o): %o", event, this);
		...
		if ( event.type == "blur" || event.type == "focusout" ) {
			...
			if( opts.persist ){
				localStorage.setItem(opts.cookieId+"-focus", "", opts.cookie);
			}
			...
			if( opts.persist ){
				localStorage.setItem(opts.cookieId+"-focus", this.data.key, opts.cookie);
			}
		}
...
//		this._log("DynaTreeStatus: read");
		...
		var cookie = localStorage.getItem(this.cookieId + "-active");
		this.activeKey = ( cookie === null ) ? "" : cookie;
		if( cookie !== null ){
			this.cookiesFound = true;
		}
		cookie = localStorage.getItem(this.cookieId + "-focus");
		this.focusedKey = ( cookie === null ) ? "" : cookie;
		if( cookie !== null ){
			this.cookiesFound = true;
		}
		cookie = localStorage.getItem(this.cookieId + "-expand");
		this.expandedKeyList = ( cookie === null ) ? [] : cookie.split(",");
		if( cookie !== null ){
			this.cookiesFound = true;
		}
		cookie = localStorage.getItem(this.cookieId + "-select");
...
//		this._log("DynaTreeStatus: write");
		localStorage.setItem(this.cookieId + "-active", ( this.activeKey === null ) ? "" : this.activeKey);
		localStorage.setItem(this.cookieId + "-focus", ( this.focusedKey === null ) ? "" : this.focusedKey);
		localStorage.setItem(this.cookieId + "-expand", ( this.expandedKeyList === null ) ? "" : this.expandedKeyList.join(","));
		localStorage.setItem(this.cookieId + "-select", ( this.selectedKeyList === null ) ? "" : this.selectedKeyList.join(","));
	},
	addExpand: function(key) {
//		this._log("addExpand(%o)", key);
		if( $.inArray(key, this.expandedKeyList) < 0 ) {
			this.expandedKeyList.push(key);
			localStorage.setItem(this.cookieId + "-expand", this.expandedKeyList.join(","));
		}
	},
...
//		this._log("addSelect(%o)", key);
		if( $.inArray(key, this.selectedKeyList) < 0 ) {
			...
			localStorage.setItem(this.cookieId + "-select", this.selectedKeyList.join(","));
		}
	},
