describe TreeBuilderMiqActionCat do
  before do
    ...
    @tag1 = FactoryGirl.create(:classification, :name => 'tag_selected', :show => false)
    @folder1 = FactoryGirl.create(:classification, :name => 'folder_selected', :show => true)
    @folder1.entries.push(@tag1)
    @tag2 = FactoryGirl.create(:classification, :name => 'tag_not_selected', :show => false)
    @folder2 = FactoryGirl.create(:classification, :name => 'folder_not_selected', :show => true)
