describe('emsCommonFormController', function() {
  ...
  describe('#saveClicked', function() {
    ...
    it('delegates to miqService.miqAjaxButton', function() {
      expect(miqService.miqAjaxButton).toHaveBeenCalledWith('/ems_cloud/update/new?button=save', true);
    });
  });
  ...
  describe('#addClicked', function() {
    ...
    it('delegates to miqService.miqAjaxButton', function() {
      expect(miqService.miqAjaxButton).toHaveBeenCalledWith('/ems_cloud/create/new?button=add', true);
    });
  });
  ...
  describe('#cancelClicked', function() {
    ...
    it('delegates to miqService.miqAjaxButton', function() {
      expect(miqService.miqAjaxButton).toHaveBeenCalledWith('/ems_cloud/create/new?button=cancel');
    });
  });
