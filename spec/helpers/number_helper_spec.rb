describe ActionView::Helpers::NumberHelper do
  context "#number_to_human_size" do
    ...
    it "without options hash" do
      ...
      expect(helper.number_to_human_size(1025.terabytes)).to eq('1 PB')
  ...
  it "#number_to_rails_method" do
    ...
    expect(helper.number_to_rails_method(1025.terabytes)).to eq('1.petabytes')
  ...
  it "#rails_method_to_human_size" do
    ...
    expect(helper.rails_method_to_human_size('1025.terabytes')).to eq('1 PB')
