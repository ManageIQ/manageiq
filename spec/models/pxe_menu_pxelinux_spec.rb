RSpec.describe PxeMenuPxelinux do
  ...
  it ".parse_append" do
    a = "initrd=rhel6/initrd.img ramdisk_size=10000 inst.ks=http://192.168.252.60/pxelinux.cfg/01-78-2b-cb-00-f6-6c.ks.cfg BOOTIF=78:2b:cb:00:f6:6c"
    expect(described_class.parse_append(a)).to eq(["ramdisk_size=10000 inst.ks=http://192.168.252.60/pxelinux.cfg/01-78-2b-cb-00-f6-6c.ks.cfg BOOTIF=78:2b:cb:00:f6:6c", "rhel6/initrd.img"])
  end
