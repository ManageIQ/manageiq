...
describe ManageIQ::Providers::Azure::CloudManager::Refresher do
  before do
    ...
    @ip_address     = '13.92.40.85'    # This will change if you had to restart the VM. Update as needed.
    @mismatch_ip    = '137.135.93.76'  # This will change if you had to restart the 'miqmismatch' VM.
    @template = nil
    @avail_zone = nil
