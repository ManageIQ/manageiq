describe EventStream do
  context "::Purging" do
    ...
    context ".purge" do
      ...
      before do
        @old_event        = EmsEvent.create(:timestamp => purge_date - 1.day)
        @purge_date_event = EmsEvent.create(:timestamp => purge_date)
        @new_event        = EmsEvent.create(:timestamp => purge_date + 1.day)
      end
