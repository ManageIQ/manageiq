...
describe ManageIQ::Providers::Openstack::CloudManager::Refresher do
  ...
  def assert_specific_floating_ip
    @ip = ManageIQ::Providers::Openstack::CloudManager::FloatingIp.where(:address => "10.3.4.1").first
  ...
  def assert_specific_vm_powered_on
    ...
    @vm.security_groups.should        match_array [@sg, ManageIQ::Providers::Openstack::CloudManager::SecurityGroup.where(:name => "EmsRefreshSpec-SecurityGroup2").first]
