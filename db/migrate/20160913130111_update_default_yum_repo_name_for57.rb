class UpdateDefaultYumRepoNameFor57 < ActiveRecord::Migration[5.0]
  class MiqDatabase < ActiveRecord::Base; end

  REPO_NAME_HASH = {
    "cf-me-5.6-for-rhel-7-rpms rhel-server-rhscl-7-rpms" => "cf-me-5.7-for-rhel-7-rpms rhel-server-rhscl-7-rpms"
  }.freeze
