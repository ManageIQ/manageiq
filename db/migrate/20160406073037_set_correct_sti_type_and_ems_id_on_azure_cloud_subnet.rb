class SetCorrectStiTypeAndEmsIdOnAzureCloudSubnet < ActiveRecord::Migration[5.0]
  ...
  def up
    ...
    ExtManagementSystem
      ...
      CloudSubnet
        ...
        .update_all("type = 'ManageIQ::Providers::Azure::NetworkManager::CloudSubnet', ems_id = '#{ems.id}'")
    end
  end
  ...
  def down
    ...
    CloudSubnet
      ...
      .where(:cloud_subnets => {:type => 'ManageIQ::Providers::Azure::NetworkManager::CloudSubnet'},
             :cloud_manager => {:type => 'ManageIQ::Providers::Azure::CloudManager'})
