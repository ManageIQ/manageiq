...
class MiqWebServiceWorker < MiqWorker
  ...
  BALANCE_MEMBER_CONFIG_FILE = MiqApache.root_dir.join('etc/httpd/conf.d/cfme-balancer-ws.conf')
  REDIRECTS_CONFIG_FILE      = MiqApache.root_dir.join('etc/httpd/conf.d/cfme-redirects-ws')
  STARTING_PORT              = 4000
  LB_METHOD                  = :busy
