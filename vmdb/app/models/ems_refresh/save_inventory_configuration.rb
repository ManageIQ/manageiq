...
module EmsRefresh
  module SaveInventoryConfiguration
    ...
    def save_configuration_profiles_inventory(manager, hashes, target)
      save_inventory_assoc(:configuration_profiles, manager, hashes, target, "manager_ref")
    end
    ...
    def save_configured_systems_inventory(manager, hashes, target)
      ...
      save_inventory_assoc(:configured_systems, manager, hashes, target, "manager_ref", nil,
