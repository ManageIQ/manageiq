...
#     render :action=>"show"
  ...
  def dialog_partial_for_workflow
    ...
    when MiqProvisionConfiguredSystemForemanWorkflow then "miq_request/prov_configured_system_foreman_dialog"
    when MiqHostProvisionWorkflow                    then "miq_request/prov_host_dialog"
    when VmMigrateWorkflow                           then "miq_request/prov_vm_migrate_dialog"
    end
  end
