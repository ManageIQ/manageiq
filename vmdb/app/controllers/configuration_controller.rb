...
class ConfigurationController < ApplicationController
  ...
  def get_form_vars
    ...
    when "ui_1"                                               # Visual Settings tab
      @edit[:new][:quadicons][:ems] = params[:quadicons_ems] == "1" ? true : false if params[:quadicons_ems]
      @edit[:new][:quadicons][:ems_cloud] = params[:quadicons_ems_cloud] == "1" ? true : false if params[:quadicons_ems_cloud]
      @edit[:new][:quadicons][:host] = params[:quadicons_host] == "1" ? true : false if params[:quadicons_host]
      @edit[:new][:quadicons][:vm] = params[:quadicons_vm] == "1" ? true : false if params[:quadicons_vm]
      @edit[:new][:quadicons][:miq_template] = params[:quadicons_miq_template] == "1" ? true : false if params[:quadicons_miq_template]
      if get_vmdb_config[:product][:proto] # Hide behind proto setting - Sprint 34
        @edit[:new][:quadicons][:service] = params[:quadicons_service] == "1" ? true : false if params[:quadicons_service]
      end
      @edit[:new][:quadicons][:vmvdi] = params[:quadicons_vmvdi] == "1" ? true : false if params[:quadicons_vmvdi]
      @edit[:new][:quadicons][:vmitem] = params[:quadicons_vmitem] == "1" ? true : false if params[:quadicons_vmitem]
      @edit[:new][:quadicons][:storageitem] = params[:quadicons_storageitem] == "1" ? true : false if params[:quadicons_storageitem]
      @edit[:new][:quadicons][:storage] = params[:quadicons_storage] == "1" ? true : false if params[:quadicons_storage]
      @edit[:new][:quadicons][:vdicontroller] = params[:quadicons_vdicontroller] == "1" ? true : false if params[:quadicons_vdicontroller]
      @edit[:new][:quadicons][:vdidesktoppool] = params[:quadicons_vdidesktoppool] == "1"  ? true : false if params[:quadicons_vdidesktoppool]
