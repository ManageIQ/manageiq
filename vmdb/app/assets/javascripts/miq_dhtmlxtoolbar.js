...
function miqHideToolbarButtons() {
  ...
  if (typeof miq_toolbars.view_tb != "undefined") {
    for (x in miq_toolbars.view_tb.buttons) {
  ...
  if (typeof miq_toolbars.center_tb != "undefined") {
    tb = miq_toolbars.center_tb.obj;
    buttons = miq_toolbars.center_tb.buttons;
    for (x in buttons) {
      count = 0;
  ...
  if (typeof miq_toolbars.custom_tb != "undefined") {
    tb = miq_toolbars.custom_tb.obj;
    buttons = miq_toolbars.custom_tb.buttons;
    for (x in buttons) {
      count = 0;
