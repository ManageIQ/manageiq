module UiConstants
  ...
  # If a tab feature ends with _accords, it will be removed to create the tab feature name when building the ops rbac tree
  MAIN_TAB_FEATURES = [
    [MAIN_TABS[:vi],          %w{
                                dashboard
                                miq_report
