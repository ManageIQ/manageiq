    ...
    class << self
      ...
      def clouds_menu_section
        Menu::Section.new(:clo, "Clouds", [
          ...
          Menu::Item.new('cloud_tenant',        N_('Tenants'),             nil,                         {:feature => 'cloud_tenant_show_list'},                  '/cloud_tenant'),
      ...
      def automate_menu_section
        Menu::Section.new(:aut, "Automate", [
          ...
          Menu::Item.new('miq_ae_customization', N_('Customization'),   'miq_ae_class_custom_button', {:feature => 'miq_ae_customization_explorer'}, '/miq_ae_customization/explorer'),
      ...
      def configuration_menu_section
        Menu::Section.new(:set, "Configure", [
          ...
          Menu::Item.new('my_tasks',      N_('Tasks'),         'tasks',        {:feature => 'tasks', :any => true},        '/miq_proxy/index?jobs_tab=tasks'),
          Menu::Item.new('ops',           N_('Configuration'), 'ops_explorer', {:feature => 'ops_explorer', :any => true}, '/ops/explorer'),
          Menu::Item.new('miq_proxy',     N_('SmartProxies'),  'miq_proxy',    {:feature => 'miq_proxy_show_list'},        '/miq_proxy'),
