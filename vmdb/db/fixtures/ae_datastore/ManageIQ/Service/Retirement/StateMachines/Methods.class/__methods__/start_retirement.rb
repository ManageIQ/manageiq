...
if service.retired?
  $evm.log('info', "Service is already retired. Aborting current State Machine.")
  exit MIQ_ABORT
end

if service.retiring?
  $evm.log('info', "Service is in the process of being retired. Aborting current State Machine.")
  exit MIQ_ABORT
end
