class FixBooleanColumnsInClassifications < ActiveRecord::Migration
  ...
  def self.up
    ...
    change_column :classifications, :read_only,    :boolean
    change_column :classifications, :default,      :boolean
    change_column :classifications, :single_value, :boolean
  end

  def self.down
    change_column :classifications, :read_only,    :string
    change_column :classifications, :default,      :string
    change_column :classifications, :single_value, :string
  end
end
