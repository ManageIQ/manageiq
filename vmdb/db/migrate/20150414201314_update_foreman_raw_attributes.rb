class UpdateForemanRawAttributes < ActiveRecord::Migration
  def change
    ...
    remove_index :configuration_profiles, :name => 'index_configuration_profiles_on_operating_system_flavor_id'
    remove_index :configuration_profiles, :name => 'index_configuration_profiles_on_customization_script_medium_id'
    remove_index :configuration_profiles, :name => 'index_configuration_profiles_on_customization_script_ptable_id'
