  ...
  context "::Purging" do
    ...
    context "#purge" do
      it "by remaining" do
        ...
        described_class.where(:resource_id => 1).to_a.should   == [@rr1.last]
        described_class.where(:resource_id => 2).to_a.should   == [@rr2.last]
        described_class.where(:resource_id => nil).to_a.should == @rr_orphaned
      end
